...
public class VertxBuilder {
  ...
  private void initMetrics(Collection<VertxServiceProvider> providers) {
  ...
  private void initTracing(Collection<VertxServiceProvider> providers) {
